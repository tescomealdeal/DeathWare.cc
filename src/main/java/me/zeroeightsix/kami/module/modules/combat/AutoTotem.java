...
public class AutoTotem extends Module {
    ...
    public void onUpdate() {
        ...
        if (mc.player.getHeldItemOffhand().getItem() == Items.TOTEM_OF_UNDYING) {
            ...
            if (this.soft.getValue().booleanValue() && !me.zeroeightsix.kami.module.modules.combat.AutoTotem.mc.player.getHeldItemOffhand().isEmpty && (double)(AutoTotem.mc.player.getHealth() + me.zeroeightsix.kami.module.modules.combat.AutoTotem.mc.player.getAbsorptionAmount()) >= this.health.getValue()) {
                return;
            }
        }
        if (moving) {
