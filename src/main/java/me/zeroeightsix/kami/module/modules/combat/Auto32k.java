...
public class Auto32k
    ...
    protected void onEnable() {
        ...
        if (this.debugMessages.getValue().booleanValue()) {
            Command.sendChatMessage("[Auto32k] Place Target: " + this.placeTarget.x + " " + this.placeTarget.y + " " + this.placeTarget.z + " Distance: " + df.format(Auto32k.mc.player.getPositionVector().distanceTo(new Vec3d(this.placeTarget))));
        }
    }
    ...
    public void onUpdate() {
        ...
        if (this.stage == 0) {
            ...
            this.isSneaking = false;
            Auto32k.mc.player.connection.sendPacket(new CPacketPlayerTryUseItemOnBlock(this.placeTarget.add(0, 1, 0), EnumFacing.DOWN, EnumHand.MAIN_HAND, 0.0f, 0.0f, 0.0f));
            this.stage = 1;
            return;
        }
        if (this.stage == 1) {
            ...
            Auto32k.mc.playerController.windowClick(Auto32k.mc.player.openContainer.windowId, 1, this.shulkerSlot, ClickType.SWAP, Auto32k.mc.player);
        ...
        if (this.stage == 3) {
            ...
            Auto32k.mc.playerController.windowClick(Auto32k.mc.player.openContainer.windowId, 0, Auto32k.mc.player.inventory.currentItem, ClickType.SWAP, Auto32k.mc.player);
