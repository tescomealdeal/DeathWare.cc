...
public class KamiMod {
    ...
    public static final String MODID = "deathware";
    public static final String MODNAME = "DeathWare";
    ...
    private static final String KAMI_CONFIG_NAME_DEFAULT = "DeathWareConfig.json";

    public static final Logger log = LogManager.getLogger("DeathWare");
